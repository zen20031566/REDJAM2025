...
public class NoteManager : MonoBehaviour
{
    ...
    private bool hasPlayedSFX1 = false;
    ...
    private void Update()
    {
        ...
        if (!hasPlayedSFX1 && currentSongPosition >= 31.3820f)
        {
            conductor.musicSource.PlayOneShot(soundeffect);
            hasPlayedSFX1 = true;
        }

        if (!hasPlayedSFX2 && currentSongPosition >= 34.1510f)
        {
            conductor.musicSource.PlayOneShot(soundeffect);
            hasPlayedSFX2 = true;
        }
